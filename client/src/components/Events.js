...
// import {
//   TextField, Button, Select, MenuItem, FormControl, InputLabel, Typography, CircularProgress, Box, Table,
//   TableBody, TableCell, TableContainer, TableHead, TableRow, Paper
// } from '@mui/material';
...
//     if (editingEventId) {
//       try {
//         await dispatch(updateEvent({ eventId: editingEventId, eventData: newEventData }));
//       } catch (error) {
...
//       volunteer_needed: eventToEdit.volunteer_needed,
//       dogBreed: eventToEdit.dogBreed
//     });
//     setEditingEventId(eventId);
//   };
...
//     event.dogBreed.toLowerCase().includes(filter.toLowerCase())
//   );
...
//         <Box sx={{ mt: 2 }}>
//           {editingEventId ? (
//             <Button variant="contained" color="primary" onClick={handleEventAction}>Save</Button>
//           ) : (
//             <Button variant="contained" color="secondary" onClick={handleEventAction}>Create</Button>
//           )}
//         </Box>
//       </Box>
//       <TableContainer component={Paper}>
...
//                 <TableCell>{event.dogBreed}</TableCell>
//                 <TableCell>
//                   <Button onClick={() => handleEditEvent(event.id)} sx={{ mr: 1 }}>Edit</Button>
